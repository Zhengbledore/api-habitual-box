...
namespace App\Api\Extensions\CustomScout\Engine;
...
class CustomElasticsearchEngine extends Engine
{

    /*
    |--------------------------------------------------------------------------
    | Why build a new ElasticSearch Engine
    |--------------------------------------------------------------------------
    |
    | Because I use es's version is 5.0.
    | Laravel/Scout ElasticSearchEngine's $query filtered of performSearch method not support in es5.0,
    | that I need to build new one.
    |
    */
